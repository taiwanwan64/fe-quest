...
const IPA92_EXTENSION_TOTAL=IPA92_V1_V6_TOTAL+IPA92_V7_TOTAL;
...
async function loadCatalog(){
  if(!catalogPromise){
    catalogPromise=Promise.all([
      fetchJson(BASE_CATALOG_URL),fetchJson(IPA92_V1_V6_CATALOG_URL),fetchJson(IPA92_V7_CATALOG_URL)
    ]).then(([base,legacy,v7])=>{
      ...
      const extensionItems=[...legacy.items,...v7.items];
      ...
      return Object.freeze({
        ...base,
        version:`${BASE_CATALOG_VERSION}+ipa92-catalog-v1-v7`,
        extensionContentVersion:'ipa92-questions-v1-v7',
        extensionContentVersions:Object.freeze([...IPA92_V1_V6_CONTENT_VERSIONS,IPA92_V7_CONTENT_VERSION]),
...
window.FEQUEST_PROTECTED_CONTENT=Object.freeze({
  version:'v376-provider-4-ipa92-v1-v7',maxBatch:MAX_BATCH,maxCache:MAX_CACHE,catalogTotal:MERGED_CATALOG_TOTAL,
