...
const IPA92_EXTENSION_TOTAL=IPA92_V1_V6_TOTAL+IPA92_V7_TOTAL+IPA92_V8_TOTAL+IPA92_V9_TOTAL+IPA92_V10_TOTAL+IPA92_V11_TOTAL+IPA92_V12_TOTAL+IPA92_V13_TOTAL+IPA92_V14_TOTAL+IPA92_V15_TOTAL+IPA92_V16_TOTAL+IPA92_V17_TOTAL+IPA92_V18_TOTAL+IPA92_V19_TOTAL;
...
async function loadCatalog(){
  if(!catalogPromise){
    catalogPromise=Promise.all([
    ...
    ]).then(([base,legacy,v7,v8,v9,v10,v11,v12,v13,v14,v15,v16,v17,v18,v19])=>{
      ...
      const extensionItems=[...legacy.items,...v7.items,...v8.items,...v9.items,...v10.items,...v11.items,...v12.items,...v13.items,...v14.items,...v15.items,...v16.items,...v17.items,...v18.items,...v19.items];
...
window.FEQUEST_PROTECTED_CONTENT=Object.freeze({
  version:'v376-provider-16-ipa92-v1-v19',maxBatch:MAX_BATCH,maxCache:MAX_CACHE,catalogTotal:MERGED_CATALOG_TOTAL,
