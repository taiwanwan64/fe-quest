...
function currentAccessCode(){if(memoryAccessCode)return memoryAccessCode;const stored=readSessionAccessCode();if(stored){memoryAccessCode=stored;return stored}if(OPEN_PREVIEW_ACCESS)return '';throw new Error('beta_access_required');}
