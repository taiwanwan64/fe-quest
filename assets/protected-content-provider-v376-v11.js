...
const IPA92_EXTENSION_TOTAL=IPA92_V1_V6_TOTAL+IPA92_V7_TOTAL+IPA92_V8_TOTAL+IPA92_V9_TOTAL+IPA92_V10_TOTAL+IPA92_V11_TOTAL;
...
async function loadCatalog(){
  if(!catalogPromise){
    catalogPromise=Promise.all([
      fetchJson(BASE_CATALOG_URL),fetchJson(IPA92_V1_V6_CATALOG_URL),fetchJson(IPA92_V7_CATALOG_URL),fetchJson(IPA92_V8_CATALOG_URL),fetchJson(IPA92_V9_CATALOG_URL),fetchJson(IPA92_V10_CATALOG_URL),fetchJson(IPA92_V11_CATALOG_URL)
    ]).then(([base,legacy,v7,v8,v9,v10,v11])=>{
      ...
      const extensionItems=[...legacy.items,...v7.items,...v8.items,...v9.items,...v10.items,...v11.items];
      ...
      return Object.freeze({
        ...base,
        version:`${BASE_CATALOG_VERSION}+ipa92-catalog-v1-v11`,
        extensionContentVersion:'ipa92-questions-v1-v11',
        extensionContentVersions:Object.freeze([...IPA92_V1_V6_CONTENT_VERSIONS,IPA92_V7_CONTENT_VERSION,IPA92_V8_CONTENT_VERSION,IPA92_V9_CONTENT_VERSION,IPA92_V10_CONTENT_VERSION,IPA92_V11_CONTENT_VERSION]),
...
window.FEQUEST_PROTECTED_CONTENT=Object.freeze({
  version:'v376-provider-8-ipa92-v1-v11',maxBatch:MAX_BATCH,maxCache:MAX_CACHE,catalogTotal:MERGED_CATALOG_TOTAL,
