...
const IPA92_V31_CATALOG_URL=new URL('question-catalog-ipa92-v31.json',SCRIPT_URL).toString();
const IPA92_V32_CATALOG_URL=new URL('question-catalog-ipa92-v32.json',SCRIPT_URL).toString();
const IPA92_V33_CATALOG_URL=new URL('question-catalog-ipa92-v33.json',SCRIPT_URL).toString();
...
const IPA92_V31_CATALOG_VERSION='ipa92-catalog-v31';
const IPA92_V32_CATALOG_VERSION='ipa92-catalog-v32';
const IPA92_V33_CATALOG_VERSION='ipa92-catalog-v33';
const IPA92_V34_CATALOG_VERSION='ipa92-catalog-v34';
...
const IPA92_V31_CONTENT_VERSION='ipa92-questions-v31';
const IPA92_V32_CONTENT_VERSION='ipa92-questions-v32';
const IPA92_V33_CONTENT_VERSION='ipa92-questions-v33';
  ...
  if(!catalogPromise){
    catalogPromise=Promise.all([
      ...
      const entries=[
        ...
        ['v30',v30,IPA92_V30_CATALOG_VERSION,IPA92_V30_CONTENT_VERSION,IPA92_V30_TOTAL,'ipa92-original-v30'],
        ['v31',v31,IPA92_V31_CATALOG_VERSION,IPA92_V31_CONTENT_VERSION,IPA92_V31_TOTAL,'ipa92-original-v31'],
        ['v32',v32,IPA92_V32_CATALOG_VERSION,IPA92_V32_CONTENT_VERSION,IPA92_V32_TOTAL,'ipa92-original-v32'],
        ['v33',v33,IPA92_V33_CATALOG_VERSION,IPA92_V33_CONTENT_VERSION,IPA92_V33_TOTAL,'ipa92-original-v33'],
        ['v34',v34,IPA92_V34_CATALOG_VERSION,IPA92_V34_CONTENT_VERSION,IPA92_V34_TOTAL,'ipa92-original-v34']
      ];
      ...
      const extensionItems=[...legacy.items,...v7.items,...v8.items,...v9.items,...v10.items,...v11.items,...v12.items,...v13.items,...v14.items,...v15.items,...v16.items,...v17.items,...v18.items,...v19.items,...v20.items,...v21.items,...v22.items,...v23.items,...v24.items,...v25.items,...v26.items,...v27.items,...v28.items,...v29.items,...v30.items,...v31.items,...v32.items,...v33.items,...v34.items];
...
window.FEQUEST_PROTECTED_CONTENT=Object.freeze({
  version:'v376-provider-31-ipa92-v1-v34',maxBatch:MAX_BATCH,maxCache:MAX_CACHE,catalogTotal:MERGED_CATALOG_TOTAL,
