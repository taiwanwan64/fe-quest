...
async function loadCatalog(){
  if(!catalogPromise){
    catalogPromise=Promise.all([
    ...
    ]).then(([base,legacy,v7,v8,v9,v10,v11,v12,v13,v14,v15,v16,v17,v18,v19,v20,v21,v22,v23,v24,v25,v26,v27,v28])=>{
      ...
      const extensionItems=[...legacy.items,...v7.items,...v8.items,...v9.items,...v10.items,...v11.items,...v12.items,...v13.items,...v14.items,...v15.items,...v16.items,...v17.items,...v18.items,...v19.items,...v20.items,...v21.items,...v22.items,...v23.items,...v24.items,...v25.items,...v26.items,...v27.items,...v28.items];
...
window.FEQUEST_PROTECTED_CONTENT=Object.freeze({
  version:'v376-provider-25-ipa92-v1-v28',maxBatch:MAX_BATCH,maxCache:MAX_CACHE,catalogTotal:MERGED_CATALOG_TOTAL,
