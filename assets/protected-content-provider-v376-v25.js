...
async function loadCatalog(){
  if(!catalogPromise){
    catalogPromise=Promise.all([
      ...
      const extensionItems=[...legacy.items,...v7.items,...v8.items,...v9.items,...v10.items,...v11.items,...v12.items,...v13.items,...v14.items,...v15.items,...v16.items,...v17.items,...v18.items,...v19.items,...v20.items,...v21.items,...v22.items,...v23.items,...v24.items,...v25.items];
...
window.FEQUEST_PROTECTED_CONTENT=Object.freeze({
  version:'v376-provider-22-ipa92-v1-v25',maxBatch:MAX_BATCH,maxCache:MAX_CACHE,catalogTotal:MERGED_CATALOG_TOTAL,
