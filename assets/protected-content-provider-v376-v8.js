...
const IPA92_EXTENSION_TOTAL=IPA92_V1_V6_TOTAL+IPA92_V7_TOTAL+IPA92_V8_TOTAL;
...
function clearProtectedCache(){
  questionCache.clear();answerCache.clear();sessionByQuestion.clear();
}
...
async function loadCatalog(){
  if(!catalogPromise){
    catalogPromise=Promise.all([
      fetchJson(BASE_CATALOG_URL),fetchJson(IPA92_V1_V6_CATALOG_URL),fetchJson(IPA92_V7_CATALOG_URL),fetchJson(IPA92_V8_CATALOG_URL)
    ]).then(([base,legacy,v7,v8])=>{
      ...
      if(
        legacy?.version!==IPA92_V1_V6_CATALOG_VERSION||
        legacy?.contentVersion!==IPA92_V1_V6_CONTENT_VERSION||
        !sameStringArray(legacy?.contentVersions,IPA92_V1_V6_CONTENT_VERSIONS)||
        !Array.isArray(legacy.items)||legacy.items.length!==IPA92_V1_V6_TOTAL
      ...
      if(
        v7?.version!==IPA92_V7_CATALOG_VERSION||
        v7?.contentVersion!==IPA92_V7_CONTENT_VERSION||
        !sameStringArray(v7?.contentVersions,[IPA92_V7_CONTENT_VERSION])||
        !Array.isArray(v7.items)||v7.items.length!==IPA92_V7_TOTAL
      ...
      if(
        v8?.version!==IPA92_V8_CATALOG_VERSION||
        v8?.contentVersion!==IPA92_V8_CONTENT_VERSION||
        !sameStringArray(v8?.contentVersions,[IPA92_V8_CONTENT_VERSION])||
        !Array.isArray(v8.items)||v8.items.length!==IPA92_V8_TOTAL
      ...
      const extensionItems=[...legacy.items,...v7.items,...v8.items];
      ...
      return Object.freeze({
        ...base,
        version:`${BASE_CATALOG_VERSION}+ipa92-catalog-v1-v8`,
        extensionContentVersion:'ipa92-questions-v1-v8',
        extensionContentVersions:Object.freeze([...IPA92_V1_V6_CONTENT_VERSIONS,IPA92_V7_CONTENT_VERSION,IPA92_V8_CONTENT_VERSION]),
...
window.FEQUEST_PROTECTED_CONTENT=Object.freeze({
  version:'v376-provider-5-ipa92-v1-v8',maxBatch:MAX_BATCH,maxCache:MAX_CACHE,catalogTotal:MERGED_CATALOG_TOTAL,
