...
check("panels reset the generic bubble rule", ".sort-compare-v367>.sort-panel-v367{width:100%;max-width:none;margin:0;font-size:inherit;line-height:normal}" in source)
check("headings use one-column mobile grid", "grid-template-columns:minmax(0,1fr)" in source)
check("heading line boxes are consistent", ".sort-panel-v367 h4>span{line-height:1.35}" in source)
