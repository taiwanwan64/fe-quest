...
let rnd=123456789;Math.random=()=>{rnd=(Math.imul(rnd,1664525)+1013904223)>>>0;return rnd/4294967296;};
...
reset();seedDue(25);startQuiz('taperreview');const taper={dueBefore:dueQuestions().length,launched:quizItems.length,ids:quizItems.map(q=>q.sourceId||q.id)};
