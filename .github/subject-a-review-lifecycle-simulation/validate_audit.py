...
const sources={gradeCurrentQuestion:String(gradeCurrentQuestion),adaptiveMemoryUpdate:String(adaptiveMemoryUpdate),isDue:String(isDue),reviewUrgency:String(reviewUrgency),dueQuestions:String(dueQuestions),buildReviewItem:String(buildReviewItem),registerReviewJourney:String(registerReviewJourney),registerReviewedMiss:String(registerReviewedMiss),markJourneyAnswer:String(markJourneyAnswer),activeReviewJourneys:String(activeReviewJourneys),journeyFor:String(journeyFor),questionHasActiveJourney:String(questionHasActiveJourney)};
