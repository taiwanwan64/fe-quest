...
for token in ['SUBJECT_B_READINESS_V222_SPEC','const _subjectBHubRecommendationV222=subjectBHubRecommendation;','profile.subjectBReadinessV222','globalThis.SUBJECT_B_READINESS_V222_SPEC=SUBJECT_B_READINESS_V222_SPEC;']:
