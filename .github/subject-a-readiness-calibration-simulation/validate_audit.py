...
const sources={calcReadiness:String(calcReadiness),readinessComponents:String(readinessComponents),subjectACognitiveEvidence:String(subjectACognitiveEvidence),memoryHealth:String(memoryHealth),renderReadiness:String(renderReadiness)};
