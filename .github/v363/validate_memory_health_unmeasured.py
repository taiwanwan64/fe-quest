...
check("measured retention algorithm remains unchanged",function_block(js,"memoryHealth").replace("avg:0","avg:100").replace("  // An empty learning-evidence set has no retention rate. Keep the numeric fallback at\n  // zero for downstream calculations; the dashboard presents it as unmeasured.\n","")==function_block(transform_js(previous,"v362","v363"),"memoryHealth"))
