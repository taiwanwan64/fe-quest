...
(function(root){
  ...
  function activateV31Provider(){
    ...
    return new Promise(resolve=>{
      ...
      script.id=id;
      script.src='./assets/protected-content-provider-v376-v31.js';
      script.async=false;
  ...
  const latestProviderReady=activateV31Provider();
