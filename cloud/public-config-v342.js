...
(function(root){
  ...
  function activateV32Provider(){
    ...
    return new Promise(resolve=>{
      ...
      script.id=id;
      script.src='./assets/protected-content-provider-v376-v32.js';
      script.async=false;
  ...
  const latestProviderReady=activateV32Provider();
