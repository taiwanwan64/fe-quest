...
s=s.replace('new Set(retiredAdapters).size===9','new Set(retiredAdapters).size===10')
...
req('retiredAdapters.length===10' in s and 'new Set(retiredAdapters).size===10' in s and 'a.retiredAdapters===10' in s,'retired adapter count assertions')
...
print('FEQUEST_V170_WRAPPER_CONTRACT_ALIGNED archive=52 retired-adapters=10 exact-inventory=10')
